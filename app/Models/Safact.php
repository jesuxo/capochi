...
class Safact extends Model
{
    ...
    protected $fillable = ['nrounico', 'fk_sucursal', 'TipoFac', 'numeror', 'NumeroD', 'numerof', 'EsCorrel','FechaT','FechaI','FechaE','FechaV','fechac',
    ...
    public function operacion  (){
        ...
        return $this->belongsTo(Saoper::class, 'CodOper', 'CodOper')
