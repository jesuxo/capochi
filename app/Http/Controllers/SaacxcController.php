...
class SaacxcController extends Controller
{
    ...
    public function cxclist(Request $request)
    {
        ...
        $sqlcostoinv = "
                                                    ...
                                                    WHERE
                                                        ...
                                                        AND c.fk_sucursal in ($arraysucursales)
                                                        $datafechas
                                                        ...
                                                        a.codclie,
                                                         (c.saldo / c.tasadolar) AS saldo,
                                                         (c.saldo / c.tasadolar) AS saldodivisa
                                                    FROM
                                                        saclie AS a
                                                    JOIN
                                                        saacxc AS c
        ...
        $vista  = view('saacxclistado', compact( 'operaciones','saldocxc', 'codclie', 'fecha1', 'fecha2'))->render();
    ...
    public function descargar(Request $request)
    {
        ...
        $saacxc = Saacxc::selectRaw('id, montodolares, fk_sucursal, codclie, document,notas1,notas2, codoper,
        ...
        if ($saacxc) {
            ...
            $auxsaacxc['saacxc'][] = [
                ...
                'codoper'       => (isset($saacxc->codoper))? $saacxc->codoper : '',
    ...
    public function descargarDescuento(Request $request)
    {
        ...
        // Buscar descuentos pendientes de descargar (tipo 98 que aún no han sido procesados)
