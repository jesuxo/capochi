...
@section('css')
    <style>
        ...
        .nav-pills .nav-link.active  {
            background: #f95a02 !important;
            border-bottom-right-radius: 0 !important;
            border-bottom-left-radius: 0 !important;
        }
        .nav-pills{
            border-bottom: 1px solid #f95a02;
        }
        .tdline{
    ...
    <div class="row">
                                                ...
                                                <p class="text-muted fs-13 mb-3">No se encontraron clientes para la busqueda: <b>{{$busqueda}} </b> </p>
                                                    ...
                                                    <a class="card btn btn-soft-light  card-animate d-flex p-2
                                                       ...
                                                       style="text-align: left; display: none" >
                                                        <div class="flex-grow-1" href="#addClient" data-bs-toggle="modal">
                        ...
                        <div class="modal-dialog modal-lg modal-dialog-scrollable ">
                            <div class="modal-content">
                                <div class="modal-header px-4 pt-4">
                                    <h5 class="modal-title" id="exampleModalLabel">Informaci&oacute;n de cliente nuevo</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"
                                            id="close-modal"></button>
                                </div>
                                <form name="form2" id="form2" class="tablelist-form"   action="{{route('cliente.store')}}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-2">
                                                    ...
                                                    <input type="text" id="cliente-cod-field" name="codclie" value="{{(isset($busqueda))? $busqueda : ''}}" class="form-control"
                                                           placeholder="Ej: 0000001" required>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="mb-2">
                                                    <label for="id3-cod-field" class="form-label">C&eacute;dula / RIF</label>
                                                    <input type="text" id="id3-cod-field" name="id3" class="form-control" value="V-{{(isset($busqueda))? $busqueda : ''}}"
                                            ...
                                            <div class="col-lg-12">
                                                <div class="mb-2">
                                                    ...
                                                    <input type="text" id="descrip-name-field" name="descrip" class="form-control"
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-2">
                                                    ...
                                                    <input type="text" name="clase" id="clase-field" class="form-control" placeholder="" >
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="mb-2">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-2">
                                                    ...
                                                    <input type="text" name="represent" id="represent-field" class="form-control" placeholder="" >
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="mb-2">
                                                    <label for="movil-field" class="form-label">Celular</label>
                                                    <input type="text" name="movil" id="movil-field" class="form-control" placeholder="Ej: 5841412345678">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="mb-2">
                                                    <label for="fax-field" class="form-label">Fax</label>
                                                    <input type="text" name="fax" id="fax-field" class="form-control" placeholder="">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class=" ">
                                                    <label for="direc1-field" class="form-label">Direcci&oacute;n1</label>
                                                    <input type="text" name="direc1" id="direc1-field" class="form-control" placeholder="">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class=" ">
                                                    <label for="direc2-field" class="form-label">Direcci&oacute;n2</label>
                                                    <input type="text" name="direc2" id="direc2-field" class="form-control" placeholder="" >
                                                </div>
                                            </div>
        ...
        <div class="col-xxl-9">
            @if(isset($cliente) and isset($cliente->descrip))
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-shrink-0 " style="margin-left: 20px; display: none ">
                                <a  class="btn btn-primary"  href="#updateClient" data-bs-toggle="modal" >Modificar</a>
                            </div>
                        </div>
                ...
                <div class="modal fade" id="updateClient" tabindex="-1" aria-labelledby="updateClient" aria-hidden="true">
                    <div class="modal-dialog modal-lg modal-dialog-scrollable ">
                        <div class="modal-content">
                            <div class="modal-header px-4 pt-4">
                                <h5 class="modal-title" id="exampleModalLabel">Informaci&oacute;n del {{$cliente->descrip}}</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"
                                        id="close-modal"></button>
                            </div>
                            <form name="form3" id="form3" class="tablelist-form"   action="{{route('updatecliente')}}"
                                  autocomplete="off" method="post">
                                @csrf
                                @method('POST')
                                <div class="modal-body p-4">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-2">
                                                <label for="cliente-cod-field" class="form-label">C&oacute;digo</label>
                                                <input type="text" id="cliente-cod-field" name="codclie" value="{{$cliente->codclie}}" class="form-control"
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-2">
                                                <label for="id3-cod-field" class="form-label">C&eacute;dula / RIF</label>
                                                <input type="text" id="id3-cod-field" name="id3" class="form-control" value="{{$cliente->id3}}"
                                                       placeholder="Ej: V-12312311" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="mb-2">
                                                <label for="descrip-name-field" class="form-label">Nombre</label>
                                                <input type="text" id="descrip-name-field" value="{{$cliente->descrip}}" name="descrip" class="form-control"
                                                       placeholder="Ej: Pedro Perez" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mb-2">
                                                <label for="email-field" class="form-label">  Email</label>
                                                <input type="email" name="email" id="email-field" class="form-control" value="{{$cliente->email}}" placeholder="Ej: correo@email.com">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mb-2">
                                                <label for="clase-field" class="form-label">  Clase</label>
                                                <input type="text" name="clase" id="clase-field" value="{{$cliente->clase}}" class="form-control" placeholder="" >
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mb-2">
                                                <label for="phone-field" class="form-label">Tel&eacute;fono</label>
                                                <input type="text" name="telef" id="phone-field" class="form-control" value="{{$cliente->telef}}" placeholder="Ej: 0414-12345678"
                                                       required>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mb-2">
                                                <label for="represent-field" class="form-label">  Representante</label>
                                                <input type="text" name="represent" id="represent-field" value="{{$cliente->represent}}" class="form-control" placeholder="" >
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mb-2">
                                                <label for="movil-field" class="form-label">Celular</label>
                                                <input type="text" name="movil" id="movil-field" class="form-control" value="{{$cliente->movil}}" placeholder="Ej: 5841412345678">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mb-2">
                                                <label for="fax-field" class="form-label">Fax</label>
                                                <input type="text" name="fax" id="fax-field" class="form-control" value="{{$cliente->fax}}" placeholder="">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class=" ">
                                                <label for="direc1-field" class="form-label">Direcci&oacute;n1</label>
                                                <input type="text" name="direc1" id="direc1-field" class="form-control" value="{{$cliente->direc1}}" placeholder="">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class=" ">
                                                <label for="direc2-field" class="form-label">Direcci&oacute;n2</label>
                                                <input type="text" name="direc2" id="direc2-field" class="form-control" value="{{$cliente->direc2}}" placeholder="" >
                                            </div>
                                        </div>
                                ...
                                <div class="modal-footer">
                                    <div class="hstack gap-2 justify-content-end">
                                        <button type="button" class="btn btn-ghost-danger" data-bs-dismiss="modal">Cerrar</button>
                                        <button type="button" onclick="$('#form3').submit()" class="btn btn-success">Modificar</button>
                                    </div>
                                </div>
                            </form>
                        </div>
