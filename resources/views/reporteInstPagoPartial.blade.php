{{-- resources/views/reporteInstPagoPartial.blade.php --}}
    <style>
        .botoncal{
        ...
        .modal-header {
            background: linear-gradient(135deg, #61885f 0%, #61885f 100%);
            color: white;
                            ...
                            @if($fecha1 != '')
                                ...
                                <div class="card-body " style="background: #f8faff; padding: 10px 0 !important;" id="contentReport">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-hover align-middle" style="border-color: #61885f;" id="tablainstpagobs">
                                            <thead>
                                            <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            @foreach($clases as $index => $data)
                                                                ...
                                                                <td class="tdline p-3" style="text-align: right !important">
                                                                    @if($monto != 0)
                                                                        <a href="javascript:;" style="text-align: right !important" class="text-decoration-none text-primary text-end "
                                            ...
                                            <tr style="background: #61885f;">
                                                <td class="tdline p-3  text-white" style="background: #61885f; border-color: white;">
                                                    <i class="bi bi-calculator me-2"></i> GRAN TOTAL
                                                </td>
                                                <td colspan="{{ count($clases) }}" class="tdline text-end p-3  text-white"
                                                    style="background: #61885f; border-color: white; font-size: 18px;">
