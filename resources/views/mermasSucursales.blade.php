    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" name="form1" id="form1" action="/operaciones/mermas/sucursales">
                    ...
                    <div class="table-responsive">
                        <table class="report-table" id="tablaMermas">
                            ...
                            @foreach($itemmermas as $categoria => $productos)
                                    ...
                                    <tr @if(($n%2)!=0) style="background-color: #f8f9fa;" @endif>
                                        ...
                                        @foreach($sucursales as $idSuc => $nombreSuc)
                                            @php
                                                ...
                                                // Clase para el badge según la cantidad
