            ...
            <div class="d-flex align-items-center">
                ...
                <style>
                    .dropdown-item.active {
                        background: linear-gradient(135deg, #75a373 0%, #0f6a0a 100%);
                ...
                <div class="dropdown topbar-head-dropdown ms-1 header-item dropdown-hover-end">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-dark rounded-circle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <i class="bi bi-arrow-left-right align-middle fs-20 text-white"></i>
                    </button>
                ...
                <div class="dropdown  header-item topbar-user topbar-head-dropdown dropdown-hover-end" style="background-color: #61885f">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0 overflow-hidden" id="search-dropdown">
                ...
                <div class="dropdown-head rounded-top">
                    <div class="p-3">
                        <div class="row align-items-center">
                            <div class="col">
                                <h6 class="m-0 fs-14 text-muted fw-semibold" id="coincideciascon"> Coincidencias con la busqueda </h6>
                            </div>
                    ...
                    <script>
                        ...
                        $( document ).ready(function() {
                            ...
                            $('.busquedaproductos').unbind('change').bind('change',function () {
                                ...
                                if(busqueda)
                                    $('#coincideciascon').html('Coincidencias con la busqueda: <b>'+busqueda+'</b>' )
                                else
                                    $('#coincideciascon').html('Ud puede filtrar su los resultados buscando el producto que desea' );
