            ...
            <div class="row g-4">
                ...
                <div class="col-lg-8">
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6" style="padding: 0 17px;">
                        ...
                        <div class="col-md-6 text-md-end" style="padding: 0 17px;">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered product-table" style="background: white;">
                            <thead>
