                    ...
                    <div class="card-body p-0">
                        <div class="accordion accordion-flush" id="accordionInventario">
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header d-flex justify-content-between" style="align-items: center;">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#collapseSucursales" aria-expanded="false" style="width: 60%">
                                        <i class="bi bi-building me-2"></i> Inventario por Sucursal
                                    </button>

                                    <button type="button" class="btn btn-sm btn-outline-primary me-2" style="height: 31px;"
                                            onclick="exportarExcel('tablainventariosucus')">
                                ...
                                <div id="collapseSucursales" class="accordion-collapse collapse  ">
                                    <div class="accordion-body p-0">
                                        ...
                                        <div class="table-responsive"  style="padding: 15px">
                                            ...
                                            <table id="tablainventariosucus" class="table table-sm table-hover table-inventory mb-0">
                                                <thead>
                                                <tr>
                                                ...
                                                @if($instanciasConStock > 0)
                                                    @php
                                                        ...
                                                        function renderizarCategoria($codinst, $instanciasInfo, $instanciasPorPadre, $nivel = 0) {
                                                            ...
                                                            $html .= $inst['label'].'<i class="bi bi-box-arrow-up-right ms-1" style="font-size: 10px; margin-left: 12px !important;  color: #f95a02;"></i>';
                                                            $html .= '</a>';
                                                            $html .= '</td>';
            ...
            <div class="modal-dialog modal-fullscreen modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header bg-primary text-white">
                        <div style="width: 80%" class="d-flex gap-3 align-items-center justify-content-between">
                            ...
                            <button type="button" class="btn btn-sm btn-outline-light me-2" style="height: 43px;"
                                    onclick="exportarExcel('productosallinstancias')">
                                <i class="bi bi-file-excel"></i> Exportar a Excel
                            </button>
