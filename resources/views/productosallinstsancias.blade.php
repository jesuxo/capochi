        ...
        <div class=" row ">
            <div class="card card-height-100">
                ...
                <div class="card-body" data-simplebar style="max-height: 490px;">
                    <table width="1000px" border="0" id="productosallinstancias"
                        ...
                        @foreach($productos as $index => $producto)
                            ...
                            <tr  bgcolor="{{$bgcolor}}" style="color:#333;">
                                ...
                                <td align="center" class="titulo ">
                                    ...
                                    @endphp
                                    {{(isset($existencias[$index][$indexdep]))? number_format($existencias[$index][$indexdep]+0,2,',','.') :'' }}</td>
                                @endforeach
                                <td align="center"   class="titulo  "> {{ number_format($existdeps +0,2,',','.')   }}</td>
                        ...
                        <tr   style="color:#333;">
                            ...
                            @foreach($deposito as $indexdep => $descripdepo)
                                <td align="center" class="titulo tdlineff ">  {{($arraycantdep[$indexdep])?  number_format($arraycantdep[$indexdep] +0,2,',','.') :'' }}</td>
                            @endforeach
                            <td align="right"   class="titulo  "> {{ number_format($existdepstt +0,2,',','.')  }} </td>
