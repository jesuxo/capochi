...
@section('css')
    <style>
        ...
        .btn-outline-secondary {
            --tb-btn-color: #f95a02!important;
            --tb-btn-border-color: #f95a02 !important;
        }

        .btn-outline-secondary:hover {
            color: white;
            background-color: #f95a02 !important;
            border-color: #f95a02 !important;
        }

        .carneicon, .polloicon, .cochinoicon {
            font-size: 2rem;
            font-style: normal;
        }
    </style>
...
@section('content')
    ...
    <div class="row  ">
        <div class="col-12">
            <div class="card bg-gradient-primary text-white border-0"  style="margin: 0px !important; background: transparent !important;">
                <div class="card-body mb-2 " style="padding: 0px !important; background: transparent !important;">
                    <div class="d-flex justify-content-between align-items-center" style="background: transparent !important;">
                        <div>
                            <h3 class="mb-1" style="color: #61885f;">¡Bienvenido de nuevo, {{ Auth::user()->first_name ?? 'Usuario' }}!</h3>

                        </div>
                        <div class="text-end">
                            <div class="h4 mb-1" style="color: #61885f;">{{ now()->format('l, d F Y') }} <small>{{ now()->format('h:i A') }}</small></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-start justify-content-between">
                        <div>
                            ...
                            <a href="/inventario/historico" class="stretched-link text-decoration-none">
                                <div class="mt-3 text-muted small">
                                    Ver panel de inventario <i class="ri-arrow-right-line"></i>
                                </div>
                            </a>
                        </div>
    ...
    <div class="row g-4  ">
        ...
        <div class="col-lg-4">
            <div class="card dashboard-card  ">
                <div class="card-header bg-transparent border-0">
                    <h5 class="section-title mb-0">
                        <i class="polloicon" style="display: inline-block; transform: scaleX(-1);">🍗</i>
                        Kilos de Pollo
                    </h5>
                </div>
        ...
        <div class="col-12">
            <div class="quick-actions">
                ...
                <div class="d-flex flex-wrap gap-2">
                    ...
                    <a href="/tarjetas" class="quick-action-btn">
                        <i class="bi bi-list-ul"></i> Ubicar Instrumentos de pago
                    </a>
                </div>
            </div>
        </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            <div class="d-flex gap-2">
                                <button class="btn btn-outline-secondary flex-grow-1" type="button" style="height: 49px" id="btnBuscarDevolucion">
