{{-- resource\views\product-list.blade.php --}}
        ...
        <div class="col-xl-4 col-lg-4">
            ...
            <div class="card overflow-hidden" id="saprodpreview">
                <div class="accordion accordion-flush filter-accordion">
                                    ...
                                    <li>
                                        <div href="#" class="d-flex  align-items-center">
                                            ...
                                            <div class="flex-grow-1" >
                                                <a href="/saprod/export/{{$instancia->codalte}}" style="  padding-left: {{($instancia->nivel-1)*14}}px">
                    ...
                    <form action="{{ url('saprod/saexis') }}" name="form11" id="form11" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('post')
                        <div class="card-body border-bottom">
                            <p class="text-muted text-uppercase fs-13 m b-4">Enviar Inventario Diario</p>

                            <div id="product-price-range" data-slider-color="info"></div>
                            <div class="formCost gap-2 align-items-center mt-3">

                                <!-- Selector de sucursal -->
                                <select class="form-select" data-choices id="idsucu" name="fksucursal" required>
                                ...
                                <!-- NUEVO: Selector de fecha del inventario -->
                                <div class="mb-2">
                                    <label class="form-label text-muted fs-13">Fecha del Inventario</label>
                                    <input type="date" name="fecha_inventario" class="form-control"
                                           value="{{ date('Y-m-d') }}" required>
                                    <small class="text-muted">Selecciona la fecha a la que corresponde este inventario</small>
                                </div>
