                    ...
                    <form  method="post" name="form1" id="form1" action="/ventas/productos/sucursales">
                        <div class="row">
                            ...
                            <div class="col-md-1 mb-2">
                                ...
                                <div class="input-group">
                                    <button type="button" class="btn btn-sm btn-outline-primary me-2" style="height: 40px;"
                                            onclick="exportarExcel('productossucursales')">
    ...
    <div class="row">
        ...
        <div class="col-md-12 ">
            ...
            <div class="table-responsive table-card mt-3">
                <table  border="0" width="100%"  style="border-radius: 5px !important;" id="productossucursales"
                        class="table table-borderless table-centered align-middle table-nowrap mb-0 mt-3" >
