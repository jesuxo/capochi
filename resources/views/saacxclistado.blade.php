    ...
    <div class="row" style="justify-content: left !important;">
        <div class="col-12">
            ...
            <div class="card" style="background: #e1f7e6;">
                ...
                <div class="card-body">
                    ...
                    <div class="tab-content" >
                        ...
                        <div class="tab-pane fade  show active" id="instrumentosUsd" role="tabpanel">
            ...
            <div class="row mt-3">
                <div class="col-md-6"  >
                    <div class="mb-2">
                        <label class="form-label small">Tipo Operaci&oacute;n</label>
                        <select class="form-control form-control-sm" id="codoperinput" name="codoperinput">
                            <option> Seleccionar </option>
                            @if(isset($operaciones))
                                @foreach($operaciones as $operacion)
                                    <option value="{{$operacion->codoper}}"> {{substr($operacion->descrip,4,50)}} </option>
                                @endforeach
                            @endif
                        </select>
                    </div>
