{{-- resources/views/reporteInstPago.blade.php --}}
...
@section('css')
    ...
    <style>
        ...
        .modal-header {
            background: linear-gradient(135deg, #f95a02 0%, #f95a02 100%);
            color: white;
                    ...
                    <form  method="post" name="form1" id="form1">
                        ...
                        <div class="row mt-3">
                            ...
                            @endif
                                <div class="col-md-2">
                                    <select class="form-select" data-choices onchange="$('#form1').submit()"
                                            id="codoper" name="codoper">
                                        <option value="">   ---TODO---   </option>
                                        @foreach($operaciones as $oper)
                                            <option value="{{$oper->codoper}}" {{($codoper == $oper->codoper)?'selected':''}}>
                                                {{substr($oper->descrip,4,50)}}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
